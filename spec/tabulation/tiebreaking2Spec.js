...
describe("Tabulation Tiebreaking Single Direction", function() {

  describe("Tiebreaking Single Direction", function() {
    ...
    function testExpectedTiebreakAll(maxCount, allTableScoresPerRider, heatRiders, expectedRanks, tieExpected) {
      ...
      var enableLeftRightRule = false;

      var originalHighestTableScoresPerRider = Tabulation.getHighestTableScoresPerRider(allTableScoresPerRider, maxCount, enableLeftRightRule);
      ...
      var completedResults = Tabulation.getCompleteRiderRanks(allTableScoresPerRider, maxCount, enableLeftRightRule, heatRiders);
    ...
    it("Should tie due to no left right rule", function() {
      var MAX_COUNT = 3;
      var allTableScoresPerRider = {
        'id1': [
          createTableScore(1, 'left', 5),
